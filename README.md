...
- Lightning fast video anomaly detection via multi-scale adversarial distillation (**CVIU** 2024) [[paper]](https://www.sciencedirect.com/science/article/pii/S1077314224001553) [[code]](https://github.com/ristea/fast-aed)
...
- Video Anomaly Detection via Sequentially Learning Multiple Pretext Tasks (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com/content/ICCV2023/html/Shi_Video_Anomaly_Detection_via_Sequentially_Learning_Multiple_Pretext_Tasks_ICCV_2023_paper.html)
- SSMTL++: Revisiting Self-Supervised Multi-Task Learning for Video Anomaly Detection (**CVIU** 2023) [[paper]](https://arxiv.org/abs/2207.08003) [[code]](https://github.com/lilygeorgescu/AED-SSMTL)
- Multimodal Motion Conditioned Diffusion Model for Skeleton-based Video Anomaly Detection (**ICCV** 2023) [[paper]](https://openaccess.thecvf.com//content/ICCV2023/papers/Flaborea_Multimodal_Motion_Conditioned_Diffusion_Model_for_Skeleton-based_Video_Anomaly_Detection_ICCV_2023_paper.pdf) [[code]](https://github.com/aleflabo/MoCoDAD)
...
- Self-Supervised Predictive Convolutional Attentive Block for Anomaly Detection (**CVPR** 2022) [[paper]](https://arxiv.org/abs/2111.09099) [[code]](https://github.com/ristea/sspcab)
- Self-Supervised Masked Convolutional Transformer Block for Anomaly Detection (**TPAMI** 2022) [[paper]](https://arxiv.org/pdf/2209.12148v2) [[code]](https://github.com/ristea/ssmctb)
- Abnormal Event Detection and Localization via Adversarial Event Prediction (**TNNLS** 2022) [[paper]](https://ieeexplore.ieee.org/abstract/document/9346050)
- Video Anomaly Detection by Solving Decoupled Spatio-Temporal Jigsaw Puzzles (**ECCV** 2022) [[paper]](https://arxiv.org/abs/2207.10172) 
### 2021
- Anomaly Detection in Video via Self-Supervised and Multi-Task Learning (**CVPR** 2021) [[paper]](https://arxiv.org/abs/2011.07491) [[code]](https://github.com/ristea/fast-aed)
- A Hybrid Video Anomaly Detection Framework via Memory-Augmented Flow Reconstruction and Flow-Guided Frame Prediction (**ICCV oral** 2021) [[paper]](https://arxiv.org/abs/2108.06852) [[code]](https://github.com/LiUzHiAn/hf2vad)
- Appearance-Motion Memory Consistency Network for Video Anomaly Detection (**AAAI** 2021) [[paper]](https://ojs.aaai.org/index.php/AAAI/article/view/16177)
### 2019
- Memorizing Normality to Detect Anomaly: Memory-augmented Deep Autoencoder for Unsupervised Anomaly Detection (**ICCV** 2019) [[paper]](https://arxiv.org/abs/1904.02639) [[code]](https://donggong1.github.io/anomdec-memae) 
